...
class Remove_Taxonmy_Slug_Public {
	...
	public function __construct( $plugin_name, $version ) {
		...
		add_filter( 'term_link', array( $this,'remtaxslug_term_permalink' ), 10, 3);
	...
	public function enqueue_styles() {
		 ...
		 * defined in Remove_Taxonmy_Slug_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Remove_Taxonmy_Slug_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/remove-taxonmy-slug-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/remove-taxonmy-slug-public.js', array( 'jquery' ), $this->version, false );
	 ...
	 * @since    1.0.0
	 */
	public function remtaxslug_term_permalink($url, $term, $taxonomy){
